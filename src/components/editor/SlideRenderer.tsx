...
export function SlideRenderer({ slide, head, interactive = true }: SlideRendererProps) {
...
function buildSlideSrcdoc(slide: SlideModel, head: string, interactive: boolean): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
${head}

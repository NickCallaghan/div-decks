    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
          <h2 style={{ fontSize: 16, fontWeight: 600, color: '#111' }}>Keyboard Shortcuts</h2>
          <button
            onClick={onClose}
            style={{
              border: 'none',
        ...
        <div style={{ marginTop: 20, fontSize: 12, color: '#999', textAlign: 'center' }}>
          Press <kbd style={{ padding: '1px 5px', fontSize: 11, background: '#f5f5f5', border: '1px solid #ddd', borderRadius: 4 }}>Cmd+I</kbd> or <kbd style={{ padding: '1px 5px', fontSize: 11, background: '#f5f5f5', border: '1px solid #ddd', borderRadius: 4 }}>Esc</kbd> to close
        </div>
      </div>
    </div>
  );
